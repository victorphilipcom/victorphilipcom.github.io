...
<body>
  <aside id="top-pick-sidebar">
    ...
    <a id="more-link" href="https://victorphilip.com/Rankings" class="cta-button">Want more…?</a>
  </aside>
      ...
      fetch("example_holding.json")
        ...
        .then(data => {
          ...
          sb.querySelector(".description").textContent = 
            At Victor Philip, we believe in evaluating companies from ALL possible perspectives. You wouldn't buy a house based on its price alone, it might have a crumbling foundation. It's the same for companies! +
            ${top.name || ticker} scores high on stable growth, low valuation, high return on capital,  +
            great balance‐sheet strength, a stable cash‐flow, positive sentiment and high industry momentum.;
